...
export function useRetentionRate() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getRetentionRate();
        return data;
      } catch (error) {
...
export function useFlightRiskEmployees() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getFlightRiskEmployees();
...
export function useComplaintTrends() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getComplaintTrends();
...
export function useCommunicationVolume() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getCommunicationVolume();
        return data;
      } catch (error) {
...
export function useSentimentAnalysis() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getRetentionSentiment();
        return data;
      } catch (error) {
...
export function useMeetingLoad() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getMeetingLoad();
        return data;
      } catch (error) {
