...
export function useSecurityRisks() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getSecurityRisks();
...
export function useHarassmentMessages() {
  return useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await apiService.getHarassmentMessages();
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        // const { data } = await apiService.getUnwantedBehaviors();
        // return data;
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        // const { data } = await apiService.getRiskDistribution();
        // return data;
